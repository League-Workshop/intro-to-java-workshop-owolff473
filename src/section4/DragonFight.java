...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		String input = JOptionPane.showInputDialog(null, "yell or kick");
		// 9. If they typed in "yell":
		if (input.equals("yell")) {
			//-- Find a random number between 0 and 10 and store it in dragonDamage
			dragonDamage = new Random().nextInt(10);
			//-- Subtract that number from the dragon's health variable 
			dragonDamage -= dragonHealth;}
		...
		if (dragonHealth<=0) {
			...
			JOptionPane.showMessageDialog(null, "The dragon is dead and you got to take lots of gold!");
		}
	   //  15.  Else
